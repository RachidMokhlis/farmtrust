...
export default function Landing() {
  ...
  return (
    <div dir={isRTL?'rtl':'ltr'} className="overflow-guard">
      ...
      <section ref={statsRef} style={{background:'linear-gradient(135deg,#1B5E20,#2E7D32)',padding:'48px 20px'}}>
        <div style={{maxWidth:800,margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:16,textAlign:'center'}}>
          {STAT_DATA.map((s,i) => (
